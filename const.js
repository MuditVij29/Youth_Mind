...
export const MUSIC_TRACK_ASSIGNMENTS = {
    "Sad": {
        ...
        description: "Soothing tracks for sadness"
    },
    "Fear": {
        start: 7,
        end: 8,
        description: "Calming tracks for anxiety/fear"
    },
    "Anger": {
        start: 9,
        end: 10,
        description: "Relaxing tracks to cool down"
    },
    "Disgust": {
        start: 11,
        end: 12,
        description: "Balancing tracks for disgust"
    },
    "Surprise": {
        start: 5,
        end: 6,
        description: "Upbeat tracks for surprise"
    },
    "Happy": {
        start: 1,
        end: 2,
        description: "Cheerful tracks for happiness"
    }
};
